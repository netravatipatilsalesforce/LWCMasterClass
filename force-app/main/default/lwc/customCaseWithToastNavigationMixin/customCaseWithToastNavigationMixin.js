...
export default class CustomCaseWithToastNavigationMixin extends NavigationMixin(LightningElement) {
    ...
    async createCase()
    {
        ...
        .then((record) => {  
            this.ShowToast('Success','Your record has been successfully created!','success','dismissable');
