...
export default class ZodiacSignMessenger extends LightningElement {
    ...
    onclick:function(){
         ...
         just going to check with my zodiac mAster date as to which zodiac sign it falls into
         and then display the sign.
    }*/ 
    ...
    handleSubmit(){
        ...
        console.log('Date of Birth is :' + this.userBirthDate);

        //if both values have been entered: we want to proceed; to check what is the zodiac sign and zodiac trait.
    ...
    checkZodiacSign(month, day){
        ...
        //iterate over all my Zodiac signs that I have in my Array , extract and compare for which one - month and day condition is working - as in , it satisfies the condition.

        console.log('Data recieved :' + month + ' Day: ' + day);
        ...
        for(let sign of this.zodiacTraits){
            ...
            if((month === fromMonth && day >= fromDay) || (month === toMonth && day <= toDay)){
                console.log('Sign Recieved in if Condition : ' + JSON.stringify(sign));
